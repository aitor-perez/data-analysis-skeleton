...
% Suppress Quarto's default \maketitle (we render a custom title block).
\renewcommand{\maketitle}{}

% --- Adaptive section page breaks -------------------------------------------
% The `section-newpage` metadata flag controls whether each top-level section
% starts a new page. Default: true. Set to false for a continuous flow.
...
% --- Compact title block -----------------------------------------------------
% Renders an inline title block: \brieftitle{title}{subtitle}{date}.
% Typically used together with the inline-title branch in before-body.tex.
...
% --- Figure paths ------------------------------------------------------------
% \graphicspath is set once for this deliverable in the Quarto YAML header-includes,
% so paths resolve from the project root.
