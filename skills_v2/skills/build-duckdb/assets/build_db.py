# build_db.py — Build the DuckDB database from raw data
# Generated by the build-duckdb skill. Edit this script to import and transform your data.
# Run: python build_db.py  (from this directory)
...
try:
    ...
    schema_lines.append("_Run `build_db.py` to rebuild the database and regenerate `schema.md`._\n")
